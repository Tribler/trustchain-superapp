...
import com.example.offlinemoney.OfflineMoneyMainActivity.OfflineTokenPreferences.DEMO_MODE_ENABLED
import com.example.offlinemoney.OfflineMoneyMainActivity.OfflineTokenPreferences.OFFLINE_MONEY_SHARED_PREF_NAME
import com.example.offlinemoney.db.TrustStore
import com.example.offlinemoney.ui.settings.DefaultGateway
...
class EuroTokenCommunity(
    ...
    fun sendAddressesOfLastTransactions(peer: Peer, num: Int = 50) {
        val pref = myContext.getSharedPreferences(OFFLINE_MONEY_SHARED_PREF_NAME, Context.MODE_PRIVATE)
