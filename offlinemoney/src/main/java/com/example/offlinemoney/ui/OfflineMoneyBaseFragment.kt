package com.example.offlinemoney.ui
...
import com.example.offlinemoney.OfflineMoneyMainActivity
import com.example.offlinemoney.R
import com.example.offlinemoney.db.TrustStore
...
open class OfflineMoneyBaseFragment(contentLayoutId: Int = 0) : BaseFragment(contentLayoutId) {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.offlinemoney_options, menu)
    ...
    private fun getDemoModeMenuItemText(): String {
        val pref = requireContext().getSharedPreferences(
            OfflineMoneyMainActivity.OfflineTokenPreferences.OFFLINE_MONEY_SHARED_PREF_NAME,
            Context.MODE_PRIVATE
        )
        val demoModeEnabled = pref.getBoolean(OfflineMoneyMainActivity.OfflineTokenPreferences.DEMO_MODE_ENABLED, false)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            ...
            R.id.toggleDemoMode -> {
                ...
                edit.putBoolean(
                    OfflineMoneyMainActivity.OfflineTokenPreferences.DEMO_MODE_ENABLED,
                    !sharedPreferences.getBoolean(OfflineMoneyMainActivity.OfflineTokenPreferences.DEMO_MODE_ENABLED, false)
                )
                edit.commit()
