...
class WalletManagerTest {
    ...
    fun testEntranceFeeTransactionWithWitnessTx() {
        ...
        val userBitcoinPk = LegacyAddress.fromString(params, "bc1qxtk5uxp2ka68za6jxzz7e8xnq5wh5tqxd02fx4")
        val transactionHash = Sha256Hash.wrap("a7e93dc1c53d45dbd3bb7f342991c068065059e33fceedf6a3fc0887bd5a056a".hexToBytes())
        val sharedWalletBitcoinPk = LegacyAddress.fromString(params, "1K6BWqtaXpDiZ4PEiPR3pNyXb4ZveKRWqm")
        val entranceFee = 0.01831933

        val entranceFeePayed = WalletManager.checkEntranceFeeTransaction(userBitcoinPk, transactionHash, sharedWalletBitcoinPk, entranceFee)
    ...
    fun testEntranceFeeTransactionWithInvalidTx() {
        ...
        val userBitcoinPk = LegacyAddress.fromString(params, "bc1qxtk5uxp2ka68za6jxzz7e8xnq5wh5tqxd02fx4")
        val transactionHash = Sha256Hash.wrap("a7e93dc1c53d45ddd3bb7f342991c068065059e33fceedf6a3fc0887bd5a056a".hexToBytes())
        val sharedWalletBitcoinPk = LegacyAddress.fromString(params, "1K6BWqtaXpDiZ4PEiPR3pNyXb4ZveKRWqm")
        val entranceFee = 0.01831933
    ...
    fun testEntranceFeeTransactionValidOurTx() {
        ...
        val transactionHash = Sha256Hash.wrap("c0f8fdb122ac1f2db46652ac39afa0dd0ef1d9457eff684dc7ac5699ebc34a19".hexToBytes())
        val sharedWalletBitcoinPk = LegacyAddress.fromString(params, "1BoCA9Y3z7NjQuFffdjKPo4PghWGRjsR5Y")
    ...
    fun testEntranceFeeTransactionValid() {
        ...
        val transactionHash = Sha256Hash.wrap("3c5771e1c8e40056ef04d96dade01d707fade25c3847f98c93f03715accd4414".hexToBytes())
        val sharedWalletBitcoinPk = LegacyAddress.fromString(params, "1CbpHMm5AXRVTuXXZ7rL4wShcRKosdCQPZ")
        val entranceFee = 1.0
