# Unverified Transfers in ConfIDapp with Trust Network
...
- Eduard Klein Onstenk (4930894)
- Leon de Klerk (4907922)
...
The store is an Android room database, and can importing the store and invoking `trustDao()`. The dao object contains the actual query calls to insert/update/delete entries in the database.
