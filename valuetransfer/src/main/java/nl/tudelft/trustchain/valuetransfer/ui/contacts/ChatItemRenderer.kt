    ...
    override fun bindView(
        ...
        val message =
            when {
                ...
                item.lastMessage.attachment != null ->
                    when (item.lastMessage.attachment.type) {
                        ...
                        MessageAttachment.TYPE_IDENTITY_ATTRIBUTE ->
                            this.context.resources.getString(
                                R.string.text_attachment_identity_attribute
                            )
                        ...
                        MessageAttachment.TYPE_TRANSFER_REQUEST ->
                            this.context.resources.getString(
                                R.string.text_attachment_transfer_request
                            )
                        ...
                        MessageAttachment.TYPE_IDENTITY_UPDATED ->
                            this.context.resources.getString(
                                R.string.text_attachment_identity_updated
                            )
