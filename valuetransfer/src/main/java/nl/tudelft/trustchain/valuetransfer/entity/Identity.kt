...
data class PersonalIdentity(
    ...
    override fun toString(): String {
        return "$givenNames $surname ($gender) born on $dateOfBirth as $nationality. " +
            "Personal number $personalNumber, document number $documentNumber. " +
            "Identity is verified: $verified. Expires on $dateOfExpiry"
    }
}
