...
fun saveFile(
    ...
    try {
        ...
        Toast.makeText(context, "Document export failed: ${e.localizedMessage}", Toast.LENGTH_LONG)
            .show()
...
fun saveImage(
    ...
    try {
        ...
        // TODO: Needs usage of MediaStore to make the image visible in the gallery.
        ...
        Toast.makeText(context, "Image export failed: ${e.localizedMessage}", Toast.LENGTH_LONG)
            .show()
        e.printStackTrace()
    }
}
