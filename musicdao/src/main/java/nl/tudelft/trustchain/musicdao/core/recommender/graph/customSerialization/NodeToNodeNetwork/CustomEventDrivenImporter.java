...
public class CustomEventDrivenImporter
    extends
    BaseEventDrivenImporter<Pair<Integer, String>, Quadruple<Integer, Integer, Double, Long>>
    implements
    EventDrivenImporter<Pair<Integer, String>, Quadruple<Integer, Integer, Double, Long>>
{
    /**
    ...
    public void importInput(Reader input)
    {
        ...
        while (cols != null) {
            if (cols[0].equals("e") || cols[0].equals("a")) {
                ...
                notifyVertex(Pair.of(nodeId, node));
            }
