...
class NodeToNodeNetwork {
    ...
    constructor(serializedString: String, representation: NetworkRepresentation) {
        if(representation == NetworkRepresentation.JSON) {
    ...
    fun serialize(): String {
        ...
        nodeNetworkJSONExporter.exportGraph(graph, stringWriter)
    ...
    fun serializeCompactZipped(): ByteArray {
        return gzip(serializeCompact())
    }
