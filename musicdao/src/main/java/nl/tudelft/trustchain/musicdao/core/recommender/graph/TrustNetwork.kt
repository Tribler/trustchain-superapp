...
open class TrustNetwork {
    ...
    protected val incrementalPersonalizedPageRank: IncrementalPersonalizedPageRank
    protected val incrementalHybridPersonalizedPageRankSalsa: IncrementalHybridPersonalizedPageRankSalsa
