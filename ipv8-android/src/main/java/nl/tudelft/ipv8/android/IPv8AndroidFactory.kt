...
class IPv8AndroidFactory(
    ...
    fun setPrivateKey(key: PrivateKey): IPv8AndroidFactory {
        this.privateKey = key
        return this
    }

    fun setConfiguration(configuration: IPv8Configuration): IPv8AndroidFactory {
        this.configuration = configuration
        return this
    }

    fun setCryptoProvider(cryptoProvider: CryptoProvider): IPv8AndroidFactory {
    ...
    fun create(): IPv8 {
        ...
        val cryptoProvider = cryptoProvider
            ?: throw IllegalStateException("CryptoProvider is not set")
