...
class SendAmountFragment : OfflineDigitalEuroBaseFragment(R.layout.send_amount_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        runBlocking(Dispatchers.IO) {
            ...
            binding.numberPicker10.max = db.tokensDao().getCountTokensOfValue(10.0)
            updateBalance()
        }
        ...
        binding.numberPicker10.value = 0
        ...
        binding.numberPicker10.valueChangedListener = ValueListener()
