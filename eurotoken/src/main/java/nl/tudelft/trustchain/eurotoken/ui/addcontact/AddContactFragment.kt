package nl.tudelft.trustchain.eurotoken.ui.addcontact
...
import nl.tudelft.trustchain.eurotoken.databinding.FragmentAddContactBinding
        ...
        binding.btnSave.setOnClickListener {
            ...
            if (name.isNotEmpty()) {
                ...
                if (publicKeyBin != myPublicKey) {
                    EuroTokenStore.getInstance(requireContext())
