...
object RevocationService {
    ...
    fun getRevocationToken(baseToken: String): String {
        val base32Encoder = Base32()
//        return toBase32String(DigestUtils.sha256(baseToken)).replace("=", "")
        return base32Encoder.encodeAsString(DigestUtils.sha256(baseToken)).replace("=", "")
    }
}
