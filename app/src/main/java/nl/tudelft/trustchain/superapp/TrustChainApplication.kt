package nl.tudelft.trustchain.superapp
...
import nl.tudelft.trustchain.superapp.service.TrustChainService
...
class TrustChainApplication : Application() {
    ...
    private fun createDemoCommunity(): OverlayConfiguration<DelftDaoCommunity> {
        val randomWalk = RandomWalk.Factory()
        return OverlayConfiguration(
            Overlay.Factory(DelftDaoCommunity::class.java),
            listOf(randomWalk)
        )
    }
