...
import nl.tudelft.trustchain.currencyii.util.taproot.Schnorr.p
...
val SECP256K1_ORDER =
    BigInteger("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", 16)
...
class Key {
     ...
     */
    fun generate_schnorr_nonce(): ECKey {
        val pk = randomKey()
        assert(pk != BigInteger("0"))
        val point = ECPoint(p, Schnorr.n)
        val R = point.affineX
