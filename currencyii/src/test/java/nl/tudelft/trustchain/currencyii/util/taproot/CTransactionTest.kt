...
class CTransactionTest {
    ...
    fun cTransactionSerializeWithWitness2() {
        ...
        spendingTx.wit.vtxinwit =
            arrayOf(
                CTxInWitness(
                    arrayOf(
                        "7bdd007a2ada0fbf18fe8ea7858398e2775195db1a2cef127ef38eef861027bf4f058be84a536603799b4acce1f0eeb048c634d740aa38351cb18b7465e4b125".hexToBytes()
                    )
                )
            )
        ...
        val actual = spendingTx.serialize().toHex()
    ...
    fun cTransactionSerializeWithWitness() {
        ...
        val cTxInWitness =
            CTxInWitness(
                arrayOf(
                    "475ecd0cfdbbadb8fa891e7c341e6290a0ceb13f16d9943d57600bc93c26b7b5efdd37da69d86fe73d38331d407521e08c2dcde0400cdb8cb5938e7e7d831536".hexToBytes()
                )
            )
